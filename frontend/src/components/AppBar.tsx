    ...
    return(
        ...
        border-b mb-2">
            ...
            <div className="flex items-center">
                ...
                <button type="button" id="dropdownDividerButton" data-dropdown-toggle="dropdownDivider" className="rounded-full h-8 w-8 bg-gray-300 flex justify-center items-center">
                    {localStorage.getItem('name')?.charAt(0).toUpperCase()}
                    
                    </button>
                <div id="dropdownDivider" className="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
